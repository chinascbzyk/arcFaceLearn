...
public class AFRTest {
    ...
    private static Image imageA = new Image();

    private static Image imageB = new Image();
    ...
    public static void main(String[] args) {
        ...
        if (bUseRAWFile) {
            String filePathA = "/home/yk/Pictures/t.yuv";
            int yuv_widthA = 640;
            int yuv_heightA = 480;
            int yuv_formatA = ASVL_COLOR_FORMAT.ASVL_PAF_I420;

            String filePathB = "/home/yk/Pictures/t1.yuv";
            int yuv_widthB = 640;
            int yuv_heightB = 480;
            ...
            String filePathA = "/home/yk/Pictures/my.jpg";
            String filePathB = "/home/yk/1509528867470.jpg";
//            String filePathB = "/home/yk/Pictures/y5.png";
//            String filePathB = "/home/yk/Pictures/tmp/t.jpg";
//   1509528866189:29.8/1509528867470:41.2/1509528867667:65.2
//            c5:5239/d2:6583/t:6023/t4:5279
            inputImgA = loadImage(filePathA);
            inputImgB = loadImage(filePathB);

            imageA.setPath(filePathA);
            imageB.setPath(filePathB);
        }
    ...
    public static float compareFaceSimilarity(Pointer hFDEngine, Pointer hFREngine, ASVLOFFSCREEN inputImgA, ASVLOFFSCREEN inputImgB) {
        ...
        imageA.setList(faceInfosA);

        float rs = 0;
        float threshold = 0.2f;

        System.out.println(faceInfosB.length);
        for (FaceInfo faceInfoB : faceInfosB) {
            AFR_FSDK_FACEMODEL faceFeatureB = extractFRFeature(hFREngine, inputImgB, faceInfoB);
